...
import {View, Text, StyleSheet, FlatList, Image, Alert, Platform, TouchableOpacity} from 'react-native';
...
class FlatListLayoutViewAboveBotton extends Component{
    constructor (props){
        super(props)
        this.state = {
            deletedRowKey : null
    ...
    render(){
        return (
            ...
            <View style={{backgroundColor: 'tomato', height:60, flexDirection:'row', justifyContent:'flex-end', alignItem:'enter'}} >
                 <TouchableOpacity style={{marginTop:20, marginRight:20}} underlayColor ='tomato' onPress={this.onPressAdd}>
...
export default FlatListLayoutViewAboveBotton;